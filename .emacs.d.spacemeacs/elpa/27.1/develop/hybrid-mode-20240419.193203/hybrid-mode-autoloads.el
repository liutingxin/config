...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hybrid-mode" '("disable-hybrid-editing-style" "enable-hybrid-editing-style" "evil-insert-state-p" "hybrid-")))
